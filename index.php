...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" contRCADOent="width=device-width, initial-scale=1.0">
            ...
            <div class="row justify-content-center">
                <div class="col-4">
                    <form class="mt-4" action="index.php" method="POST" >
                        <div class="row">
                            <div class="col">
                                <input type="text" name="producto1" class="form-control" placeholder="Producto1">
                            </div>
                            <div class="col">
                                <input type="text" name="precio1" class="form-control" placeholder="Precio1($)">
                            </div>
                        </div>
                        <button type="submit" name="botonCalcular" class="btn btn-primary mt-2 btn-block col-12">Calcular</button>
                    </form>
